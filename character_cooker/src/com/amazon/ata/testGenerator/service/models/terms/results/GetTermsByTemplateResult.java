...
public class GetTermsByTemplateResult {
    private List<TermModel> terms;

    public GetTermsByTemplateResult() {
    }

    public GetTermsByTemplateResult(Builder builder) {
    ...
    public static final class Builder {
        ...
        public GetTermsByTemplateResult build() {
            return new GetTermsByTemplateResult(this);
        }
    }
}
