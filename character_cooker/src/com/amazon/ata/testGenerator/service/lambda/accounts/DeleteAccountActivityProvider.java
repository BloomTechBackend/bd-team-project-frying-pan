...
public class DeleteAccountActivityProvider implements RequestHandler<DeleteAccountRequest, DeleteAccountResult> {

    public DeleteAccountActivityProvider() {
    }

    @Override
    public DeleteAccountResult handleRequest(final DeleteAccountRequest request, Context context) {
        return getDaggerServiceComponent().provideDeleteAccountActivity().handleRequest(request, context);
    }
